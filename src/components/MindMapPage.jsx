...
function MindMapPage() {
  ...
  // Handle initial panel state setup - only set initial state, don't override user preferences
  useEffect(() => {
    // Only set initial state if all panels are in their default state
    // This prevents overriding user's panel preferences
    setPanelStates(prev => {
      // If this is the initial load (all panels are true), keep them as is
      // If user has already hidden some panels, preserve their state
      return prev
    })
  }, [])
